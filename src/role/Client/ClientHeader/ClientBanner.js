...
const ClientBanner = () => {
  return (
    <div className="h-fit md:h-screen w-full bg-[#EFF3F9] py-[35%] px-[5%]">
      <div className="w-full flex items-center h-full gap-4 flex-col md:flex-row">
        <div className="w-full md:w-1/2 h-full flex items-center md:items-start justify-center flex-col">
